...
ifeq ($(hostname),mescal606)
	CUDA_INSTALL_PATH ?= /usr/local/cuda
endif

ifeq ($(hostname),telperion)
	CUDA_INSTALL_PATH ?= /usr/local/cuda
endif

ifeq ($(hostname),r56)
	CUDA_INSTALL_PATH ?= /usr/mill/pkg/cuda-2.0
endif
...
ifeq ($(hostname),s84)
	CUDA_SDK_PATH ?= $(HOME)/cuda_sdk-2.0b2
endif
...
# Includes
INCLUDES  += -I. -I$(CUDA_INSTALL_PATH)/include -I$(COMMONDIR)/inc -I$(ROOTDIR)/include -I../include
...
# Libs
LIB       := -L$(CUDA_INSTALL_PATH)/lib -L$(LIBDIR) -L$(COMMONDIR)/lib -lcuda -lcudart -lblas -lcublas -lcutil ${OPENGLLIB} ${LIB} 
