...
# Includes
INCLUDES  += -I. -I$(CUDA_INSTALL_PATH)/include -I$(COMMONDIR)/inc -I$(ROOTDIR)/include -I../include -I$(ACMLDIR)/include
...
# Libs
LIB       := -L$(CUDA_INSTALL_PATH)/lib -L$(LIBDIR) -L$(COMMONDIR)/lib -lcuda -lcudart -lblas -lcublas -Llib/linux/release ${OPENGLLIB} ${LIB}
...
# Libs
LIB       := -L$(CUDA_INSTALL_PATH)/lib -L$(LIBDIR) -L$(COMMONDIR)/lib -L$(ACMLDIR)/lib -lacml -lblas -lcublas -lcuda -lcudart ${OPENGLLIB} $(PARAMGLLIB) ${LIB}
