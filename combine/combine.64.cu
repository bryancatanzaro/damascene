...
float hostCoefficients[] = {0.0123, 0.0110, 0.0117, 0.0169, 0.0176, 0.0198, 0.0138, 0.0138, 0.0145, 0.0104, 0.0105, 0.0115};

__constant__ float weights[12];
float hostweights[] = {0,   0,    0.0028,    0.0041,    0.0042,    0.0047,    0.0033,    0.0033,    0.0035,    0.0025,    0.0025,    0.0137,    0.0139};
...
void combine(int width, int height, int cuePitchInFloats, float* devBg, float* devCga, float* devCgb, float* devTg, float** p_devMpb, float ** p_devCombinedg) {
  int norients = 8;
